...
REM
REM Generated by Vivado on Wed Feb 25 23:01:39 +0100 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_rtype_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_rtype_vlog.prj -log xvlog.log
