...
REM
REM Generated by Vivado on Fri Mar 13 15:21:09 +0100 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_itype_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_itype_vlog.prj -log xvlog.log
