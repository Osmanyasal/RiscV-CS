...
REM
REM Generated by Vivado on Sun Feb 22 19:29:47 +0100 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_sw_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_sw_vlog.prj -log xvlog.log
