...
REM
REM Generated by Vivado on Sun Mar 01 12:19:03 +0100 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_btype_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_btype_vlog.prj -log xvlog.log
