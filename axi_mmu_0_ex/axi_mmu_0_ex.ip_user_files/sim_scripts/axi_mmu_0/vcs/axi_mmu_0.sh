...
design_libs=(xpm axi_infrastructure_v1_1_0 axi_register_slice_v2_1_35 axi_mmu_v2_1_33 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_35 $vlogan_opts +v2k +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/ipshared/c5b7/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_mmu_v2_1_33 $vlogan_opts +v2k +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/ipshared/a27c/hdl/axi_mmu_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_mmu_0 xil_defaultlib.glbl -o axi_mmu_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_mmu_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_mmu_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_mmu_0_simv.daidir vcs_lib c.obj)
