...
#
# Script generated by Vivado on Thu Apr 16 16:05:58 +03 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_mmu_0.sh
...
#
# Usage        : axi_mmu_0.sh
#                axi_mmu_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_mmu_0.sh [-reset_run]
#                axi_mmu_0.sh [-reset_log]
#                axi_mmu_0.sh [-help]
#
...
#                script (type 'axi_mmu_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_35 -libname axi_mmu_v2_1_33 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_infrastructure_v1_1_0 axi_register_slice_v2_1_35 axi_mmu_v2_1_33 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_mmu_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_mmu_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_35 $xmvlog_opts +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/ipshared/c5b7/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_mmu_v2_1_33 $xmvlog_opts +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/ipshared/a27c/hdl/axi_mmu_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/ipshared/ec67/hdl" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_mmu_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_mmu_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_mmu_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_mmu_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_mmu_0.sh [-help]\n\
Usage: axi_mmu_0.sh [-step]\n\
Usage: axi_mmu_0.sh [-lib_map_path]\n\
Usage: axi_mmu_0.sh [-reset_run]\n\
Usage: axi_mmu_0.sh [-reset_log]\n\
Usage: axi_mmu_0.sh [-keep_index]\n\
Usage: axi_mmu_0.sh [-noclean_files]\n\n\
