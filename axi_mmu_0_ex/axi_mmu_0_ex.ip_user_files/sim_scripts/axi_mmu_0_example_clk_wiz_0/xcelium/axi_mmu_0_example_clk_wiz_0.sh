...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_mmu_0_example_clk_wiz_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_mmu_0_example_clk_wiz_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_mmu_0_example_clk_wiz_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
