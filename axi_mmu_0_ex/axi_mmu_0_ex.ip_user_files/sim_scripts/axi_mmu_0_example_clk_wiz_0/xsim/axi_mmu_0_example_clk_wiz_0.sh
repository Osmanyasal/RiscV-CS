...
export RDI_DATADIR="/home/rt7/Documents/Xilinx/2025.1/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_mmu_0_example_clk_wiz_0 xil_defaultlib.axi_mmu_0_example_clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_mmu_0_example_clk_wiz_0 -key {Behavioral:sim_1:Functional:axi_mmu_0_example_clk_wiz_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/rt7/Documents/Xilinx/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_mmu_0_example_clk_wiz_0.wdb xsim.dir libdpi.so)
