...
#
# Script generated by Vivado on Thu Apr 16 16:05:57 +03 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_mmu_0_example_clk_wiz_0.sh
...
#
# Usage        : axi_mmu_0_example_clk_wiz_0.sh
#                axi_mmu_0_example_clk_wiz_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_mmu_0_example_clk_wiz_0.sh [-reset_run]
#                axi_mmu_0_example_clk_wiz_0.sh [-reset_log]
#                axi_mmu_0_example_clk_wiz_0.sh [-help]
#
...
#                script (type 'axi_mmu_0_example_clk_wiz_0.sh -help' for more information).
#
...
# script info
echo -e "axi_mmu_0_example_clk_wiz_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_mmu_0_example_clk_wiz_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_mmu_0_example_clk_wiz_0 xil_defaultlib.glbl -o axi_mmu_0_example_clk_wiz_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_mmu_0_example_clk_wiz_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_mmu_0_example_clk_wiz_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_mmu_0_example_clk_wiz_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_mmu_0_example_clk_wiz_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_mmu_0_example_clk_wiz_0.sh [-help]\n\
Usage: axi_mmu_0_example_clk_wiz_0.sh [-step]\n\
Usage: axi_mmu_0_example_clk_wiz_0.sh [-lib_map_path]\n\
Usage: axi_mmu_0_example_clk_wiz_0.sh [-reset_run]\n\
Usage: axi_mmu_0_example_clk_wiz_0.sh [-reset_log]\n\
Usage: axi_mmu_0_example_clk_wiz_0.sh [-keep_index]\n\
Usage: axi_mmu_0_example_clk_wiz_0.sh [-noclean_files]\n\n\
