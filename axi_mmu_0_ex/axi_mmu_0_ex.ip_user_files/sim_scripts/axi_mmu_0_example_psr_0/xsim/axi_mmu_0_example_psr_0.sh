...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_mmu_0_example_psr_0 xil_defaultlib.axi_mmu_0_example_psr_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_mmu_0_example_psr_0 -key {Behavioral:sim_1:Functional:axi_mmu_0_example_psr_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_mmu_0_example_psr_0.wdb xsim.dir libdpi.so)
