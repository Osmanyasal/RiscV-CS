...
design_libs=(xpm proc_sys_reset_v5_0_17 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../Documents/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_mmu_0_example_psr_0 xil_defaultlib.glbl -o axi_mmu_0_example_psr_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_mmu_0_example_psr_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_mmu_0_example_psr_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_mmu_0_example_psr_0_simv.daidir vcs_lib c.obj)
